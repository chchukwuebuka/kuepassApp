...
//     try {
//       // Use the updated clearAuth function which handles both client and server-side logout
//       await clearAuth();
//       dispatch(logout());
...
//       // Still attempt to log out on the client side if server logout fails
//       dispatch(logout());
//       await persistor.purge();
//       router.push("/");
//     }
...
//   // Enhanced logging to debug Google auth profile data
//   console.log("Navbar userInfo:", userInfo);
//   console.log("Profile URL:", userInfo?.profile_url);

//   // Function to get avatar source with proper fallback
//   const getAvatarSrc = () => {
//     return userInfo?.profile_url || "";
//   };
...
//                               );
//                               // Set fallback image using a default that definitely exists
