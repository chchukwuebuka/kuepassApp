...
import { Stack, Text, TextInput, Textarea, Select, Checkbox, Radio, Group, Box } from "@mantine/core";
...
const RegistrationFormPreview: React.FC<RegistrationFormPreviewProps> = ({ questions }) => {
  if (questions.length === 0) {
    return (
      <Box className={styles.formPreview}>
        <Text  color="dimmed">
  ...
  return (
    <Stack className={styles.formPreview}>
